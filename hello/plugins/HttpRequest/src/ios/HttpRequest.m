...
- (void)httppost:(CDVInvokedUrlCommand *)command
{
    ...
    [mananger.requestSerializer setValue:token forHTTPHeaderField:@"auth_token"];
    [mananger.requestSerializer setValue:accept forHTTPHeaderField:@"accept"];
    // mananger.responseSerializer.acceptableContentTypes=[NSSet setWithObject:@"application/json"];
    
    //        mananger.responseSerializer.acceptableContentTypes = [NSSet set:@"text/html",@"application/json"];
